<?php
//include_once('fedex/autoload.php');
...
class Fedex
{
    ...
    public function getQuote($data = '')
    {
        ...
        $rateRequest->RequestedShipment->Shipper->Address->City = 'Paris';
        // $rateRequest->RequestedShipment->Shipper->Address->StateOrProvinceCode = 'TN';
        $rateRequest->RequestedShipment->Shipper->Address->PostalCode = 75000;
        $rateRequest->RequestedShipment->Shipper->Address->CountryCode = 'FR';

        //recipient
        // $rateRequest->RequestedShipment->Recipient->Address->StreetLines = ['13450 Farmcrest Ct'];
        $rateRequest->RequestedShipment->Recipient->Address->City = 'Bayern Munich';
        // $rateRequest->RequestedShipment->Recipient->Address->StateOrProvinceCode = 'VA';
        $rateRequest->RequestedShipment->Recipient->Address->PostalCode = 80331;
        $rateRequest->RequestedShipment->Recipient->Address->CountryCode = 'DE';
